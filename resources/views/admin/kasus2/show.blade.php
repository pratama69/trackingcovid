            ...
            <div class="card">
                ...
                <div class="mb-3">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" name="jpositif"  value="{{$kasus2->jpositif}}" class="form-control" id="" readonly>
                    </div>
                    <div class="mb-3">
                        <label for="" class="form-label">Jumlah Meninggal</label>
                        <input type="text" name="jmeninggal"  value="{{$kasus2->jmeninggal}}" class="form-control" id="" readonly>
                    </div>
                    <div class="mb-3">
                        <label for="" class="form-label">Jumlah Sembuh</label>
                        <input type="text" name="jsembuh"  value="{{$kasus2->jsembuh}}" class="form-control" id="" readonly>
                    </div>
                    <div class="mb-3">
