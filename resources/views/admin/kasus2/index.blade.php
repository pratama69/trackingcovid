                      ...
                      <th scope="col">No</th>
                                    ...
                                    @foreach($kasus2 as $data)
                                        ...
                                        <tr>
                                            ...
                                            <td><center>{{$data->jpositif}}</center></td>
                                            <td><center>{{$data->jmeninggal}}</center></td>
                                            <td><center>{{$data->jsembuh}}</center></td>
                            ...
                            <form action="{{route('kasus2.destroy',$data->id)}}" method="POST">
                                ...
                                <a href="{{route('kasus2.show',$data->id)}}" class="btn btn-warning btn-sm"><i class="fa fa-eye"></i></a> 
